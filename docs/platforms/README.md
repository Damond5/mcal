...
When adding or updating platform-specific instructions, follow these guidelines:
- Use clear, step-by-step instructions with code examples.
- Include troubleshooting sections for common issues.
- Reference project-specific tools and configurations.
- Test instructions on the target platform before committing.

For general project setup, see the main [README.md](../README.md).</content>
<parameter name="filePath">docs/platforms/README.md